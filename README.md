...
```sh
# on Linux and Mac
git clone https://github.com/GoldenGamer-2022/nvim-config.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```


```
# on Windows (cmd)
git clone https://github.com/GoldenGamer-2022/nvim-config.git %userprofile%\AppData\Local\nvim\ 
```

```
# on Windows (powershell)
git clone https://github.com/GoldenGamer-2022/nvim-config.git $env:USERPROFILE\AppData\Local\nvim\ 
```
